...
def discout_and_normalize_rewards(all_rewards, discout_rate):
    all_discounted_rewards = []
    for rewards in all_rewards:
        all_discounted_rewards.append(helper_discount_rewards(rewards, discout_rate))
...
with tf.Session() as sess:
    ...
    for iteration in range(num_interations):
        ...
        all_rewards = discout_and_normalize_rewards(all_rewards, discount_rate)
        feed_dict = {}
...
with tf.Session() as sess:
    ...
    new_saver = tf.train.import_meta_graph('D:/github/reinforcement_learning/models/my-1000-step-model.meta')
    new_saver.restore(sess,'D:/github/reinforcement_learning/models/my-1000-step-model')
